...
public class T3_Array3 {
		...
		//銷售金額最多的是哪一項產品 V
			...
			public static void main(String[] args) {
				String productname[][]={{"銷售員","產品A","產品B","產品C","產品D","產品E","總計"},{"Bill","John","Kenny","各產品總額"}};
				int totalsum=0; 
				...
				sale[3][5]=totalsum;
			//	System.out.println("總銷售金額 ="+totalsum);
				...
				System.out.println("產品銷售金額最多的是"+salemaxitem+"\t金額為"+salemax);
				//以上呈現銷售金額最多的是哪一項產品 
